...
function ProfileRelationsAreaBox(props) {
    return (
        <ProfileRelationsBoxWrapper>
            ...
            <ul>
                {console.log((props.boxDados).slice(0,6))}
...
export default function Home() {
    ...
    const [comunidades, setComunidades] = React.useState([{id: new Date().toISOString(), title: "Eu odeio acordar cedo!", image: "https://alurakut.vercel.app/capa-comunidade-01.jpg"}]);
